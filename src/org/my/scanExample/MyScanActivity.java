...
public class MyScanActivity extends Activity
{
    ...
    private static final String MY_CARDIO_APP_TOKEN = "9175d4a089424e1091fffed34611dc0a";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		//Start Service MyHostApdueService and pass card information stored in resultStr in resultStr to the Service.
		Intent i = new Intent(MyScanActivity.this, MyHostApduService.class);
		Bundle b = new Bundle();
		b.putString("resultStr", resultStr);
		i.putExtras(b);
		startService(i);
